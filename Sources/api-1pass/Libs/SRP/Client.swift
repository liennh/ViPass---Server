...
public class Client {
    ...
    public func processChallenge(salt: Data, publicKey serverPublicKey: Data) throws  {
        ...
        self.v = calculate_v(group: group, x: x)
        ...
        // client verification
        M = calculate_M(group: group, algorithm: algorithm, u: u, salt: salt, A: publicKey, B: serverPublicKey, K: K!)
    ...
    // Must be called after processChallenge(...)
